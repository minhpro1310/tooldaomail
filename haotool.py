...
def fakeEmail():
  ...
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input(Fore.WHITE + Style.BRIGHT + " \033[1;33m -Nhập Số Lượng : "))
  Domain = input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập Domain(ex: yahoo) : ")
  file_email = input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập File Lưu(ex: email.txt) : ")
  n = 0
...
def checkhotmail():
  ...
  s = session()
  n_hotmail = 0
  hotmail = open(input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập File Hotmail(ex: hotmail.txt) : ")).readlines()
  hotmail_die = input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập File Lưu Hotmail Die(hotmaildie.txt) : ")
...
def checkyahoo():
  ...
  print (Fore.WHITE + Style.BRIGHT + " •CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
  n_yahoo = 0
  yahoo = open(input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập File Yahoo(ex: yahoo.txt) : ")).readlines()
  yahoo_die = input(Fore.WHITE + Style.BRIGHT + " \033[1;33m-Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : ")
...
def checkvalid():
  ...
  for email_fb in fileEmail:
    ...
    'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
    'cookie':'sb=B1jJYh5Lg0-K9hJmt7Xrpm3l; datr=B1jJYjQ9gruAqSF42COZGdQb; _fbp=fb.1.2375000715255737; locale=vi_VN; m_pixel_ratio=1.21875; wd=980x1942; 0gcxL2F3zWrsJT02T.AWXNrIj37F9IyhoXegU6dmU90LE.Bi237x.bp.AAA.0.0.Bi27fh.AWXoUgsru7Cc'# <- TOOL CHECK SAI THÌ THAY CÁI COOKIE MỚI (KO CẦN ĐĂNG NHẬP VÀO TÀI KHOẢN FB)
}
    data = {
...
\033[1;35m| |__| |     | |   ||   || ||    |  |
\033[1;35m|  __  |     | |   ||   || ||    |  |     
\033[1;35m| |  | |     | |   \\\___// \\\___//  |____
\033[1;35m\_|  |_/     \_/    \___/   \___/\______/


                Copyright By : Trần Văn Hào
                Youtube : Phạm Anh Quyết  (Support)
                Facebook : 𝑻𝒓𝒂̂̀𝒏 𝑽𝒂̆𝒏 𝑯𝒂̀𝒐  (Support)

     https://www.facebook.com/trickedlonhatvietnam47208
"""
  print (logo)
...
\033[1;33m2.
----------------------------------------------------------------------
                \033[1;33m.1. Tool Random Mail•      
                \033[1;33m.2. Tool Check Hotmail•    
                \033[1;33m.3. Tool Check Yahoo•      
                \033[1;33m.4. Tool Check liên Kết•   
                \033[1;33m.5. Thoát Tool°            
----------------------------------------------------------------------
"""
  print (Fore.WHITE + Style.BRIGHT + menu)
  choice_user = input(Fore.WHITE + Style.BRIGHT + " \033[1;33m*[HTOOL] Nhập Lựa Chọn 👇 : ")
  if choice_user == '1':
    os.system('clear')
    fakeEmail()
  if choice_user == '2':
